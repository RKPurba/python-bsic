...
periods = 10      # Number of times interest is compounded per year (monthly)

result = compound_interest(principal, rate, time, periods)
print("Compound interest after 5 years:", result)
