...
#rint("After Pop operation: ", simple_list)
...
# Modifying 
matrix[0][0] = 10
#print("Matrix after modifying element at row 1, column 1:")
for row in matrix:
    #print(row)
...
data_dict = {
    mixed_tuple: "Value associated with mixed tuple"
}
#print("Value associated with mixed tuple:", data_dict[mixed_tuple])
...
# Write your code below:
# Student grades data
students = [("Rejwana", 85), ("parah", 92), ("Mohua", 78), ("Nirjana", 95), ("Jahin", 88)]
