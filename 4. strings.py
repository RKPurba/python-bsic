...
# Bio data 
bio_data = "Name: John Smith, Age: 25, Country: United States"

# Extract
name_start = bio_data.index("Name: ") + len("Name: ")
name_end = bio_data.index(",", name_start)
name = bio_data[name_start:name_end]

age_start = bio_data.index("Age: ") + len("Age: ")
age_end = bio_data.index(",", age_start)
age = bio_data[age_start:age_end]

country_start = bio_data.index("Country: ") + len("Country: ")
...
formatted_string = f"Name: {person['name']}, Age: {person['age']}, Country: {person['country']}"
